   ...
   // sectionsByCourse.map(section => section.lessons = [{name: "first"}, {name: "second"}]);
    ...
    const sectionsList =  <div className="container">
        ...
        <div className="p-3 mb-4  border border-success rounded">
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-2">
                <Link className="btn btn-info btn-block" to={`/sectionedit/${section.id}/${this.props.course.id}`}>
                  edit section
                </Link>  
              </div>
              <div className="col-lg-2">
                <div 
                  ...
                  onClick={ () => this.props.deleteSection(section.id, this.props.course.id, this.props.history) } > 
                    delete section 
                </div>
              </div>
            </div>  
          ...
          <div class="border-top border-success my-3"></div>
            ...
            <Link className="nav-link" to={`/createlesson/${section.id}/${this.props.course.id}`}>
              Create lesson
            </Link>
                ...
                <li class="list-group-item">
                  <div className="container">
                    <div className="row">
                      ...
                      <div className="col-lg-2">
                        <Link className="btn btn-info" to={`/lessonedit/${lesson.id}/${section.id}/${this.props.course.id}`}>
                          edit lesson
                        </Link> 
                      </div>
                      <div className="col-lg-2">
                        <div 
                          ...
                          onClick={ () => this.props.deleteLesson(lesson.id, this.props.course.id, this.props.history) } > 
                          delete lesson 
                        </div>
                      </div>
                    </div>
    ...
    return (
        <div className="container">
          ...
          <Link className="nav-link" to={`/createsection/${this.props.course.id}`}>
            Create section
          </Link>
          {sectionsList}   
        </div>
